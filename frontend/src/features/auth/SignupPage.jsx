    ...
    <div style={{ maxWidth: '520px', margin: '3rem auto', width: '100%', padding: '0 1rem' }}>
      <div className="glass-panel" style={{ padding: '2.5rem' }}>
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <h2 style={{ fontSize: '1.75rem', fontWeight: 800, letterSpacing: '-0.03em', marginBottom: '0.35rem' }}>Create Workspace</h2>
          <p style={{ fontSize: '0.9rem', color: 'var(--text-secondary)' }}>Get started with your automated Multi-Tenant BI account</p>
        </div>
        ...
        <div style={{ textAlign: 'center', marginTop: '1.75rem', fontSize: '0.85rem', color: 'var(--text-secondary)' }}>
          ...
          <Link to="/login" style={{ color: 'var(--accent-primary)', fontWeight: 650, textDecoration: 'none' }}>
            Sign In here
          </Link>
        </div>
      </div>
